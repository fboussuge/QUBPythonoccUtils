#!/usr/bin/env python
descr = """Python module to provide functions/methods for common pythonocc tasks"""

import os
import sys
from pkg_resources import require

DISTNAME = 'QUBPythonoccUtils'
DESCRIPTION = descr
LONG_DESCRIPTION = descr
MAINTAINER = 'Flavien Boussuge, Liang Sun',
MAINTAINER_EMAIL = 'f.boussuge@qub.ac.uk',
URL = 'https://github.com/fboussuge/QUBPythonoccUtils'
LICENSE = 'GPLv3'
DOWNLOAD_URL = URL
PACKAGE_NAME = 'QUBPythonoccUtils'
EXTRA_INFO = dict(
    classifiers=[
